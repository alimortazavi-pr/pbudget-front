...
export function GetStartedPage() {
  ...
  return (
    <div className="min-h-dvh bg-background lg:flex lg:items-center lg:justify-center lg:p-8">
      <div className="flex min-h-dvh w-full flex-col lg:h-auto lg:min-h-[34rem] lg:max-w-5xl lg:flex-row lg:overflow-hidden lg:rounded-3xl lg:border lg:border-border/60 lg:bg-surface lg:shadow-xl">
        <div className="flex shrink-0 items-center justify-center bg-gradient-to-br from-rose-50 via-background to-background px-6 py-10 lg:min-h-[34rem] lg:flex-1 lg:from-rose-50/80 lg:via-surface-secondary lg:to-surface lg:py-0">
          <div className="text-center">
            <Image
              ...
              width={72}
              height={72}
              className="mx-auto rounded-3xl shadow-md lg:h-[88px] lg:w-[88px]"
              priority
            />
            <p className="mt-4 text-2xl font-bold text-foreground lg:mt-5 lg:text-4xl">
              {APP_NAME_FA}
            </p>
            <p className="mt-2 font-display text-sm font-semibold tracking-[0.18em] text-muted lg:text-base">
              {APP_NAME_EN}
            </p>
            <p className="mt-3 hidden max-w-xs text-sm leading-7 text-muted lg:mx-auto lg:mt-4 lg:block">
              {APP_TAGLINE_FA}
            </p>
          </div>
        </div>

        <div className="flex flex-1 flex-col rounded-t-3xl border-t border-border/50 bg-surface px-5 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-6 lg:justify-center lg:rounded-none lg:rounded-s-3xl lg:border-t-0 lg:border-s lg:px-10 lg:py-10">
          ...
          <form
            className="mt-8 flex flex-col lg:max-w-md"
