...
export const landingMessages: MessageTree = {
  "hero": {
    ...
    "description": "The desk that brings personal finance, budgeting, expense analysis, freelance projects and daily planning into one professional experience — built for Iran.",
  ...
  "seo": {
    ...
    "description": "Your personal desk for finance, budgeting, expense analysis, freelance projects and daily planning."
  }
};
