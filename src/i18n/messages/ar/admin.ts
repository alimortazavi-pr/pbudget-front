...
export const adminMessages: MessageTree = {
  ...
  planEditorHint: "اضبط سعر الخطة وفترتها وصلاحياتها.",
  planRequired: "أدخل اسم الخطة ومعرفها.",
  priceUnit: "وحدة السعر",
  featureEditorHint: "فعّل الميزات أو عطّلها وحدد الحدود اختيارياً.",
  noFeatures: "لم تتم إضافة ميزات بعد.",
