...
export const adminMessages: MessageTree = {
  ...
  planEditorHint: "قیمت، دوره و دسترسی‌های این پلن را تنظیم کنید.",
  planRequired: "نام و شناسه پلن را وارد کنید.",
  priceUnit: "واحد قیمت",
  featureEditorHint: "قابلیت‌ها را روشن/خاموش کنید و محدودیت اختیاری بدهید.",
  noFeatures: "هنوز قابلیتی اضافه نشده است.",
  featureEnabled: "فعال",
  userColumn: "کاربر",
  planColumn: "پلن",
  statusColumn: "وضعیت",
